...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Expression Gen</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.yakindu.base.generator.generator.impl.ExpressionGenImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionGenImpl extends CodeElementImpl implements ExpressionGen {
	/**
	...
	protected EClass eStaticClass() {
		return GeneratorPackage.Literals.EXPRESSION_GEN;
	}
	...
	public void setExpression(org.yakindu.base.expressions.expressions.Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GeneratorPackage.EXPRESSION_GEN__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GeneratorPackage.EXPRESSION_GEN__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorPackage.EXPRESSION_GEN__EXPRESSION, newExpression, newExpression));
	}
